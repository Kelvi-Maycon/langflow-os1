...
describe('builder practice modes', () => {
  it('creates deterministic sentence transform pairs from cached variants', () => {
    const exercises = buildTransformExercises({
      selectedWords: [{ wordId: 'word-1', wordText: 'relentless', recycled: false }],
      recentSentencesByWord: {
        'word-1': [
          {
            id: 'p',
            english: 'She is relentless at work.',
            portuguese: 'Ela e incansavel no trabalho.',
            type: 'positive',
          },
          {
            id: 'n',
            english: 'She is not relentless at work.',
            portuguese: 'Ela nao e incansavel no trabalho.',
            type: 'negative',
          },
          {
            id: 't',
            english: 'She was relentless at work.',
            portuguese: 'Ela foi incansavel no trabalho.',
            type: 'past',
          },
        ],
      },
  ...
  it('creates cloze exercises for words and collocations', () => {
    const exercises = buildClozeExercises({
      selectedWords: [{ wordId: 'word-1', wordText: 'make a decision', recycled: true }],
      recentSentencesByWord: {
        'word-1': [
          {
            id: 'p',
            english: 'We need to make a decision today.',
            portuguese: 'Precisamos tomar uma decisao hoje.',
            type: 'positive',
          },
        ],
      },
