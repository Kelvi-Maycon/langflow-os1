...
describe('builder session helpers', () => {
  it('prioritizes reader words and limits extra bank words by the configured weight', () => {
    ...
    expect(selected.map((word) => word.wordId)).toEqual([
      'reader-1',
      'reader-2',
      'bank-1',
      'bank-2',
    ...
    const exercises = buildBuilderExercises({
      ...
      recentSentencesByWord: {
        'word-1': [
          {
            id: 's1',
            english: 'I learned relentless today.',
            portuguese: 'Eu aprendi relentless hoje.',
            type: 'positive',
          },
          {
            id: 's2',
            english: 'I am not relentless yet.',
            portuguese: 'Eu ainda nao sou relentless.',
            type: 'negative',
          },
          {
            id: 's3',
            english: 'We used relentless yesterday.',
            portuguese: 'Nos usamos relentless ontem.',
            type: 'past',
          },
        ],
      },
