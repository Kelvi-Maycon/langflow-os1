    ...
    >
      {({ isActive }) => (
        <>
          ...
          <span
            className={cn(
              'flex-1 whitespace-nowrap text-[0.97rem] font-medium',
    ...
    <div className="flex h-full flex-col bg-transparent">
      <div className="border-b border-black/5 px-6 pb-6 pt-7">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-[1.4rem] font-semibold tracking-[-0.03em] text-foreground">
              LangFlow
            </div>
...
function dispatchPageAction(action) {
  ...
  window.dispatchEvent(
    new CustomEvent('langflow:page-action', {
      detail: { action },
    }),
  )
}
...
export default function AppLayout() {
  ...
  return (
    <div className="app-shell">
      ...
      {mobileOpen ? (
        <div
          className="fixed inset-0 z-50 bg-neutral-950/35 md:hidden"
