...
export function HeroWelcome() {
  return (
    <div className="relative overflow-hidden rounded-[32px] bg-card border border-border p-8 md:p-12 shadow-lg hover:shadow-xl transition-all duration-300 ease-out flex flex-col md:flex-row items-center justify-between gap-8 group">
      ...
      <div className="relative z-10 flex-1 max-w-xl">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary border border-border text-xs font-bold tracking-wider text-muted-foreground mb-6 shadow-sm">
        ...
        <div className="flex flex-wrap gap-4">
          <Button
            size="lg"
            className="rounded-full bg-pink-500 hover:bg-pink-600 text-white border-0 h-14 px-8 text-base font-bold shadow-[0_4px_14px_0_rgba(236,72,153,0.39)] transition-all duration-300 hover:scale-[1.04] active:scale-[0.98]"
          >
      ...
      <div className="relative z-10 hidden md:flex items-center justify-center w-64 h-64">
        ...
        <div className="absolute inset-0 bg-background border border-border/50 rounded-[40px] -rotate-6 shadow-lg flex items-center justify-center transition-transform duration-500 group-hover:rotate-0">
