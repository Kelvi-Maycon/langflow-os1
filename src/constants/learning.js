...
export const MISSION_META = [
  {
    key: 'readerWords',
    label: 'Leitura Matinal',
    icon: '📖',
    desc: 'Clique em novas palavras durante a leitura.',
    xp: 25,
  },
  {
    key: 'builderExercises',
    label: 'Prática Guiada',
    icon: '🧩',
    desc: 'Complete construções de frase com foco na forma correta.',
    xp: 60,
  },
  {
    key: 'flashcardReviews',
    label: 'Revisão SRS Diária',
    icon: '🧠',
    desc: 'Revisite cards devidos para manter retenção alta.',
    xp: 80,
  },
  {
    key: 'productionWrites',
    label: 'Produção Livre',
    icon: '✍️',
    desc: 'Escreva frases próprias usando o vocabulário do dia.',
    xp: 30,
  },
  {
    key: 'recycledWords',
    label: 'Reciclagem Ativa',
    icon: '♻️',
    desc: 'Reative palavras já vistas para consolidar o ciclo.',
    xp: 35,
  },
]
...
export const ACHIEVEMENT_META = {
  first_discovery: {
    ...
    desc: 'Você adicionou sua primeira palavra ao ciclo.',
  },
  builder_apprentice: {
    icon: '🧩',
    title: 'Arquiteto de frases',
    desc: 'Completou 25 exercícios no construtor.',
  },
  memory_keeper: {
    icon: '🗂️',
    title: 'Guardião do banco',
    desc: 'Salvou 20 frases em flashcards.',
  },
  ...
  weekly_rhythm: {
    icon: '📅',
    title: 'Ritmo semanal',
    desc: 'Estudou em pelo menos 4 dias na semana.',
  },
  active_lexicon: {
    icon: '🔥',
    title: 'Vocabulário ativo',
    desc: 'Levou 10 itens até o estágio ativo.',
  },
  prompt_starter: {
    icon: '📝',
    title: 'Prompt do dia',
    desc: 'Concluiu seu primeiro desafio diário de produção.',
  },
}
